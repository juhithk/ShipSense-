...
export default function PartnersPageDark({ toggleTheme }) {
  ...
  return (
    <div style={{ background: "#07060a", color: "#e0d8d0", fontFamily: "'Inter', sans-serif", overflowX: "hidden" }}>
          ...
          {navLinks.map(l => (
            <li key={l.label}>
              <a
                ...
                style={{ color: l.label === "Partners" ? "#f0a030" : "#666", textDecoration: "none", fontSize: "0.8rem", letterSpacing: "1.5px", textTransform: "uppercase", transition: "color 0.2s", borderBottom: l.label === "Partners" ? "1px solid #f0a030" : "none", paddingBottom: l.label === "Partners" ? "2px" : "0" }}
                onMouseEnter={e => e.target.style.color = "#f0a030"}
                onMouseLeave={e => e.target.style.color = l.label === "Partners" ? "#f0a030" : "#666"}
              >
                {l.label}
              </a>
            </li>
      ...
      <section style={{ minHeight: "60vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "10rem 4rem 6rem", position: "relative", overflow: "hidden", textAlign: "center" }}>
        ...
        <div style={{ position: "absolute", fontSize: "16vw", fontFamily: "'Bebas Neue', sans-serif", color: "transparent", WebkitTextStroke: "1px rgba(196,30,30,0.06)", userSelect: "none", top: "50%", left: "50%", transform: "translate(-50%,-50%)", whiteSpace: "nowrap", zIndex: 0, animation: "floatBg 8s ease-in-out infinite" }}>PARTNERS</div>
        ...
        <div style={{ position: "relative", zIndex: 2, opacity: visible ? 1 : 0, transform: visible ? "translateY(0)" : "translateY(30px)", transition: "opacity 0.9s ease, transform 0.9s ease" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: "0.8rem", marginBottom: "2rem", padding: "0.4rem 1.2rem", border: "1px solid rgba(196,30,30,0.3)", borderRadius: "999px", background: "rgba(196,30,30,0.05)" }}>
            ...
            <span style={{ fontSize: "0.7rem", letterSpacing: "3px", textTransform: "uppercase", color: "#e08080" }}>Our Partners</span>
          </div>
          <h1 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(3rem, 7vw, 6rem)", lineHeight: 0.92, marginBottom: "1.5rem", letterSpacing: "1px" }}>
            <span style={{ display: "block", background: "linear-gradient(135deg, #ffffff, #c8b8b0)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>BUILT ON TRUST.</span>
            <span style={{ display: "block", background: "linear-gradient(135deg, #e63232, #f0a030)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>POWERED BY COLLABORATION.</span>
          </h1>
      ...
      <div style={{ textAlign: "center", padding: "2rem 4rem 0" }}>
        <div style={{ fontSize: "0.65rem", letterSpacing: "4px", textTransform: "uppercase", background: "linear-gradient(90deg,#e63232,#f0a030)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", marginBottom: "1rem" }}>Who We Work With</div>
      ...
      {/* CARRIER PARTNERS */}
      <section style={{ padding: "4rem 4rem 6rem", background: "#0a0608" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ marginBottom: "3rem" }}>
            <div style={{ fontSize: "0.65rem", letterSpacing: "3px", textTransform: "uppercase", color: "#f0a030", marginBottom: "0.8rem" }}>Category 01</div>
            <h3 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "2rem", background: "linear-gradient(135deg, #ffffff, #c8b0a8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "2px", marginBottom: "0.8rem" }}>CARRIER PARTNERS</h3>
            <p style={{ fontSize: "0.88rem", color: "#6a5e5e", lineHeight: 1.9, maxWidth: "700px", fontWeight: 300 }}>The transport backbone of ShipSense. Our carrier partners span sea, air, and road — providing real-time vessel, flight, and fleet data that powers our live tracking and ETA prediction engine.</p>
          </div>

          <div style={{ display: "flex", flexDirection: "column", gap: "0.8rem", marginBottom: "3rem" }}>
            {carriers.map((c, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "1.2rem 1.8rem", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "8px", ...hover }}
                onMouseEnter={e => { e.currentTarget.style.transform = "translateX(6px)"; e.currentTarget.style.borderColor = "rgba(196,30,30,0.3)"; e.currentTarget.style.boxShadow = "0 4px 20px rgba(196,30,30,0.08)"; }}
                onMouseLeave={e => { e.currentTarget.style.transform = "translateX(0)"; e.currentTarget.style.borderColor = "rgba(255,255,255,0.06)"; e.currentTarget.style.boxShadow = "none"; }}
              >
                <div style={{ display: "flex", alignItems: "center", gap: "1.2rem" }}>
                  <div style={{ fontSize: "1.8rem", width: "48px", height: "48px", display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(196,30,30,0.08)", borderRadius: "8px", border: "1px solid rgba(196,30,30,0.15)" }}>{c.icon}</div>
                  <div>
                    <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.2rem", background: "linear-gradient(135deg, #ffffff, #c8b0a8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "1px" }}>{c.name}</div>
                    <div style={{ fontSize: "0.72rem", color: "#555", marginTop: "2px" }}>{c.type}</div>
                  </div>
                </div>
                <div style={{ fontSize: "0.75rem", color: "#6a5e5e", letterSpacing: "0.5px" }}>{c.route}</div>
                <div style={{ fontSize: "0.6rem", padding: "0.3rem 0.8rem", background: "rgba(240,160,48,0.08)", border: "1px solid rgba(240,160,48,0.2)", color: "#f0a030", letterSpacing: "1px", textTransform: "uppercase" }}>Active</div>
              </div>
            ))}
          </div>

          {/* Featured Carrier */}
          <div style={{ background: "linear-gradient(135deg, rgba(196,30,30,0.1), rgba(240,160,48,0.06))", border: "1px solid rgba(196,30,30,0.2)", borderRadius: "12px", padding: "2.5rem" }}>
            <div style={{ fontSize: "0.6rem", letterSpacing: "3px", textTransform: "uppercase", color: "#e63232", marginBottom: "0.8rem" }}>Featured Carrier</div>
            <h4 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.8rem", background: "linear-gradient(135deg, #ffffff, #c8b0a8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "2px", marginBottom: "1rem" }}>🚢 MAERSK LINE</h4>
            <p style={{ fontSize: "0.88rem", color: "#6a5e5e", lineHeight: 1.9, fontWeight: 300 }}>Maersk is the world's largest container shipping company, operating over 700 vessels across 130+ countries. Through our Maersk integration, ShipSense pulls live AIS vessel tracking data, port ETAs, and container status updates directly into the platform — giving suppliers and customers a single source of truth for ocean freight.</p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "6rem 4rem" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ marginBottom: "3rem" }}>
            <div style={{ fontSize: "0.65rem", letterSpacing: "3px", textTransform: "uppercase", color: "#f0a030", marginBottom: "0.8rem" }}>Category 02</div>
            <h3 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "2rem", background: "linear-gradient(135deg, #ffffff, #c8b0a8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "2px", marginBottom: "0.8rem" }}>PORT & CUSTOMS AUTHORITIES</h3>
            <p style={{ fontSize: "0.88rem", color: "#6a5e5e", lineHeight: 1.9, maxWidth: "700px", fontWeight: 300 }}>Direct integrations with port authorities and customs bodies enable ShipSense to detect congestion, flag customs holds, and assign accurate delay reason codes before disruption escalates.</p>
          </div>

          <div style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: "1rem", marginBottom: "3rem" }}>
            {ports.map((p, i) => (
              <div key={i} style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "8px", padding: "1.5rem 1rem", textAlign: "center", ...hover }}
                onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-4px)"; e.currentTarget.style.borderColor = "rgba(240,160,48,0.3)"; e.currentTarget.style.boxShadow = "0 8px 24px rgba(240,160,48,0.08)"; }}
              ...
              >
                ...
                <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "0.85rem", background: "linear-gradient(135deg, #ffffff, #c8b0a8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "1px", marginBottom: "0.4rem" }}>{p.name}</div>
                <div style={{ fontSize: "0.65rem", color: "#555", marginBottom: "0.6rem" }}>{p.country}</div>
                <div style={{ fontSize: "0.6rem", padding: "0.2rem 0.5rem", background: "rgba(240,160,48,0.08)", border: "1px solid rgba(240,160,48,0.2)", color: "#f0a030", display: "inline-block" }}>{p.teu}</div>
              </div>
            ))}
          </div>
          ...
          {/* Featured Port */}
          <div style={{ background: "linear-gradient(135deg, rgba(196,30,30,0.1), rgba(240,160,48,0.06))", border: "1px solid rgba(196,30,30,0.2)", borderRadius: "12px", padding: "2.5rem" }}>
            <div style={{ fontSize: "0.6rem", letterSpacing: "3px", textTransform: "uppercase", color: "#e63232", marginBottom: "0.8rem" }}>Featured Port</div>
            <h4 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.8rem", background: "linear-gradient(135deg, #ffffff, #c8b0a8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "2px", marginBottom: "1rem" }}>🏗️ PORT OF SINGAPORE</h4>
            <p style={{ fontSize: "0.88rem", color: "#6a5e5e", lineHeight: 1.9, fontWeight: 300 }}>The Port of Singapore is the world's second busiest port by container throughput, handling cargo from over 600 ports in 120 countries. ShipSense integrates directly with MPA Singapore's vessel traffic data to detect berth congestion in real time — automatically triggering D02 Port Congestion delay codes and updating affected ETAs before suppliers even need to ask.</p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "6rem 4rem", background: "#0a0608" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ marginBottom: "3rem" }}>
            <div style={{ fontSize: "0.65rem", letterSpacing: "3px", textTransform: "uppercase", color: "#f0a030", marginBottom: "0.8rem" }}>Category 03</div>
            <h3 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "2rem", background: "linear-gradient(135deg, #ffffff, #c8b0a8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "2px", marginBottom: "0.8rem" }}>TECHNOLOGY PARTNERS</h3>
            <p style={{ fontSize: "0.88rem", color: "#6a5e5e", lineHeight: 1.9, maxWidth: "700px", fontWeight: 300 }}>ShipSense integrates with best-in-class technology providers for data enrichment, weather intelligence, mapping, and analytics — ensuring our platform stays ahead of every disruption.</p>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "1rem", marginBottom: "3rem" }}>
            {techPartners.map((t, i) => (
              <div key={i} style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "8px", padding: "1.8rem", ...hover }}
                onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-4px)"; e.currentTarget.style.borderColor = "rgba(196,30,30,0.3)"; e.currentTarget.style.boxShadow = "0 8px 24px rgba(196,30,30,0.08)"; }}
                onMouseLeave={e => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.borderColor = "rgba(255,255,255,0.06)"; e.currentTarget.style.boxShadow = "none"; }}
              >
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "1rem" }}>
                  <div style={{ fontSize: "2rem" }}>{t.icon}</div>
                  <div style={{ fontSize: "0.58rem", padding: "0.2rem 0.6rem", background: "rgba(240,160,48,0.08)", border: "1px solid rgba(240,160,48,0.2)", color: "#f0a030", letterSpacing: "1px", textTransform: "uppercase" }}>{t.type}</div>
                </div>
                <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.2rem", background: "linear-gradient(135deg, #ffffff, #c8b0a8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "1px", marginBottom: "0.4rem" }}>{t.name}</div>
                <div style={{ fontSize: "0.72rem", color: "#555" }}>{t.function}</div>
              </div>
            ))}
          </div>
          ...
          {/* Featured Tech */}
          <div style={{ background: "linear-gradient(135deg, rgba(196,30,30,0.1), rgba(240,160,48,0.06))", border: "1px solid rgba(196,30,30,0.2)", borderRadius: "12px", padding: "2.5rem" }}>
            <div style={{ fontSize: "0.6rem", letterSpacing: "3px", textTransform: "uppercase", color: "#e63232", marginBottom: "0.8rem" }}>Featured Tech Partner</div>
            <h4 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.8rem", background: "linear-gradient(135deg, #ffffff, #c8b0a8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "2px", marginBottom: "1rem" }}>🌦️ TOMORROW.IO</h4>
            <p style={{ fontSize: "0.88rem", color: "#6a5e5e", lineHeight: 1.9, fontWeight: 300 }}>Tomorrow.io is the world's leading weather intelligence platform, providing hyper-local, real-time weather forecasts with up to 96-hour accuracy windows. ShipSense feeds Tomorrow.io data directly into our ML prediction engine — allowing us to anticipate weather-related delays (D01) up to four days before they impact a shipment, and proactively update ETAs before carriers report any disruption.</p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "6rem 4rem" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ marginBottom: "3rem" }}>
            <div style={{ fontSize: "0.65rem", letterSpacing: "3px", textTransform: "uppercase", color: "#f0a030", marginBottom: "0.8rem" }}>Category 04</div>
            <h3 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "2rem", background: "linear-gradient(135deg, #ffffff, #c8b0a8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "2px", marginBottom: "0.8rem" }}>SUPPLY CHAIN ECOSYSTEM</h3>
            <p style={{ fontSize: "0.88rem", color: "#6a5e5e", lineHeight: 1.9, maxWidth: "700px", fontWeight: 300 }}>Strategic alliances with supply chain platforms and ERP providers allow ShipSense to plug directly into existing enterprise workflows — no rip-and-replace required.</p>
          </div>

          <div style={{ display: "flex", flexDirection: "column", gap: "0.8rem", marginBottom: "3rem" }}>
            {ecosystem.map((e, i) => (
              <div key={i} style={{ display: "grid", gridTemplateColumns: "60px 1fr 1fr 1fr", alignItems: "center", gap: "1.5rem", padding: "1.2rem 1.8rem", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "8px", ...hover }}
                onMouseEnter={el => { el.currentTarget.style.transform = "translateX(6px)"; el.currentTarget.style.borderColor = "rgba(240,160,48,0.3)"; el.currentTarget.style.boxShadow = "0 4px 20px rgba(240,160,48,0.06)"; }}
                onMouseLeave={el => { el.currentTarget.style.transform = "translateX(0)"; el.currentTarget.style.borderColor = "rgba(255,255,255,0.06)"; el.currentTarget.style.boxShadow = "none"; }}
              >
                <div style={{ fontSize: "1.8rem", textAlign: "center" }}>{e.icon}</div>
                <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.1rem", background: "linear-gradient(135deg, #ffffff, #c8b0a8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "1px" }}>{e.name}</div>
                <div style={{ fontSize: "0.72rem", color: "#555" }}>{e.category}</div>
                <div style={{ fontSize: "0.72rem", color: "#6a5e5e" }}>{e.useCase}</div>
              </div>
            ))}
          </div>
          ...
          {/* Featured Ecosystem */}
          <div style={{ background: "linear-gradient(135deg, rgba(196,30,30,0.1), rgba(240,160,48,0.06))", border: "1px solid rgba(196,30,30,0.2)", borderRadius: "12px", padding: "2.5rem" }}>
            <div style={{ fontSize: "0.6rem", letterSpacing: "3px", textTransform: "uppercase", color: "#e63232", marginBottom: "0.8rem" }}>Featured Ecosystem Partner</div>
            <h4 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.8rem", background: "linear-gradient(135deg, #ffffff, #c8b0a8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "2px", marginBottom: "1rem" }}>📦 FLEXPORT</h4>
            <p style={{ fontSize: "0.88rem", color: "#6a5e5e", lineHeight: 1.9, fontWeight: 300 }}>Flexport is a modern digital freight forwarder managing over $10 billion in annual cargo. Through our Flexport integration, ShipSense automatically ingests shipment bookings, customs documentation status, and carrier assignments — eliminating manual data entry for suppliers and ensuring every Flexport-managed shipment is tracked with full delay code intelligence from day one.</p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "6rem 4rem", background: "#0a0608" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "4rem" }}>
            <div style={{ fontSize: "0.65rem", letterSpacing: "4px", textTransform: "uppercase", background: "linear-gradient(90deg,#e63232,#f0a030)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", marginBottom: "1rem" }}>Global Reach</div>
            <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "3rem", background: "linear-gradient(135deg, #ffffff, #c8b0a8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "2px", marginBottom: "1rem" }}>
              SPANNING EVERY MAJOR TRADE ROUTE.
            </h2>
            <p style={{ fontSize: "0.88rem", color: "#6a5e5e", lineHeight: 1.9, maxWidth: "600px", margin: "0 auto", fontWeight: 300 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.8rem" }}>
            {tradeLanes.map((t, i) => (
              <div key={i} style={{ display: "grid", gridTemplateColumns: "60px 1fr 1fr 1fr 1fr", alignItems: "center", gap: "1.5rem", padding: "1.2rem 1.8rem", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "8px", ...hover }}
                onMouseEnter={e => { e.currentTarget.style.borderColor = "rgba(196,30,30,0.3)"; e.currentTarget.style.transform = "translateX(6px)"; }}
              ...
              >
                ...
                <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1rem", background: "linear-gradient(135deg, #ffffff, #c8b0a8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "1px" }}>{t.route}</div>
                <div style={{ fontSize: "0.72rem", color: "#555" }}>{t.via}</div>
                <div style={{ fontSize: "0.72rem", color: "#6a5e5e" }}>{t.distance}</div>
                <div style={{ fontSize: "0.65rem", padding: "0.2rem 0.7rem", background: "rgba(240,160,48,0.08)", border: "1px solid rgba(240,160,48,0.2)", color: "#f0a030", display: "inline-block", textAlign: "center" }}>{t.days}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: "6rem 4rem" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "4rem" }}>
            <div style={{ fontSize: "0.65rem", letterSpacing: "4px", textTransform: "uppercase", background: "linear-gradient(90deg,#e63232,#f0a030)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", marginBottom: "1rem" }}>Partner With Us</div>
            <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "3rem", background: "linear-gradient(135deg, #ffffff, #c8b0a8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "2px", marginBottom: "1rem" }}>
              WANT TO JOIN THE SHIPSENSE NETWORK?
            </h2>
            <p style={{ fontSize: "0.88rem", color: "#6a5e5e", lineHeight: 1.9, maxWidth: "600px", margin: "0 auto", fontWeight: 300 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "1.5rem", marginBottom: "4rem" }}>
            {partnerReasons.map((r, i) => (
              <div key={i} style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "12px", padding: "2rem", ...hover }}
                ...
                onMouseLeave={e => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.borderColor = "rgba(255,255,255,0.06)"; e.currentTarget.style.boxShadow = "none"; }}
              >
                <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "3rem", background: "linear-gradient(135deg, #e63232, #f0a030)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", lineHeight: 1, marginBottom: "1rem" }}>{r.num}</div>
                <h4 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.2rem", background: "linear-gradient(135deg, #ffffff, #c8b0a8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "2px", marginBottom: "0.8rem" }}>{r.title}</h4>
                <p style={{ fontSize: "0.82rem", color: "#6a5e5e", lineHeight: 1.8, fontWeight: 300 }}>{r.desc}</p>
              </div>
            ))}
          </div>
        </div>
